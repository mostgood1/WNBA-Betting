...
RENDER_DATA_ROOT_DEFAULT=""
if [ -d "/opt/render/project/data" ]; then
  RENDER_DATA_ROOT_DEFAULT="/opt/render/project/data"
fi
ACTIVE_DATA_ROOT=${WNBA_BETTING_DATA_ROOT:-${NBA_BETTING_DATA_ROOT:-${RENDER_DATA_ROOT_DEFAULT:-data}}}
